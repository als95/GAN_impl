...
for i, (imgs, labels) in enumerate(dataloader):
    ...
    batches_done = i
    if batches_done % opt.sample_interval == 0:
        save_image(gen_imgs[0].data, "images/relativistic_gan/gen/%d_%d.png" % (batches_done, labels[0]), nrow=n_row, normalize=True)
        save_image(real_imgs[0].data, "images/relativistic_gan/origin/%d_%d.png" % (batches_done, labels[0]), nrow=n_row, normalize=True)